...
import pine.toast.toastrpg.core.Extras
import pine.toast.toastrpg.core.TKeys
import pine.toast.toastrpg.core.ToastRPG
import pine.toast.toastrpg.core.events.*
import pine.toast.toastrpg.core.monsters.Monster
import pine.toast.toastrpg.core.monsters.MonsterType
...
class HandleEntities : Listener {
    ...
    private fun monsterSpawnCall(event: EntitySpawnEvent) {
        ...
        val monsterType: MonsterType = entityData.get(TKeys.MONSTER_TYPE, ToastRPG.getAdapterManager()!!.monsterTypeAdapter)!!
    ...
    private fun monsterTargetCall(event: EntityTargetLivingEntityEvent) {
        ...
        val entity: LivingEntity = event.entity as LivingEntity
        val monster: Monster = ToastRPG.getMonsterFactory()!!.getMonster(entity)
        val monsterType: MonsterType = entity.persistentDataContainer.get(TKeys.MONSTER_TYPE, ToastRPG.getAdapterManager()!!.monsterTypeAdapter)!!
    ...
    private fun monsterDeathCall(event: EntityDeathEvent) {
        ...
        val monsterType: MonsterType = event.entity.persistentDataContainer.get(TKeys.MONSTER_TYPE, ToastRPG.getAdapterManager()!!.monsterTypeAdapter)!!
