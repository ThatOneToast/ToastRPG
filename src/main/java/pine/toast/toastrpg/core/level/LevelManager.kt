package pine.toast.toastrpg.core.level

import org.bukkit.entity.Player
import org.bukkit.persistence.PersistentDataType
import pine.toast.toastrpg.core.TKeys
import pine.toast.toastrpg.core.ToastRPG
import pine.toast.toastrpg.core.events.PlayerGainExperienceEvent
...
class LevelManager {
    ...
    private fun addExperience(player: Player, amount: Int) {
        val currentLevel: Int = player.persistentDataContainer.get(TKeys.LEVEL, PersistentDataType.INTEGER)!!
        val exp: Int = player.persistentDataContainer.get(TKeys.EXP, PersistentDataType.INTEGER)!!
        val maxLevel: Int = player.persistentDataContainer.get(TKeys.MAX_LEVEL, PersistentDataType.INTEGER)!!
        ...
        if (exp >= experienceUntilLevelUp) {
            if ((currentLevel + 1) > maxLevel) {
                ...
                player.persistentDataContainer.set(TKeys.LEVEL,PersistentDataType.INTEGER, currentLevel + 1)
            }
    ...
    fun removeExperience(player: Player, amount: Int) {
        val exp: Int = player.persistentDataContainer.get(TKeys.EXP, PersistentDataType.INTEGER)!!
        player.persistentDataContainer.set(TKeys.EXP, PersistentDataType.INTEGER, exp - amount)
    }
    ...
    fun setExperience(player: Player, amount: Int) {
        player.persistentDataContainer.set(TKeys.EXP, PersistentDataType.INTEGER, amount)
    }
    ...
    fun setLevel(player: Player, level: Int) {
        ...
        if (level >= maxLevel) {
            ...
            player.persistentDataContainer.set(TKeys.LEVEL, PersistentDataType.INTEGER, maxLevel)
        } else {
    ...
    fun setMaxLevel(player: Player, maxLevel: Int) {
        player.persistentDataContainer.set(TKeys.MAX_LEVEL, PersistentDataType.INTEGER, maxLevel)
    }
    ...
    fun getExperience(player: Player): Int {
        return player.persistentDataContainer.get(TKeys.EXP, PersistentDataType.INTEGER)!!
    }
    ...
    fun getLevel(player: Player): Int {
        return player.persistentDataContainer.get(TKeys.LEVEL, PersistentDataType.INTEGER)!!
    }
    ...
    fun getMaxLevel(player: Player): Int {
        return player.persistentDataContainer.get(TKeys.MAX_LEVEL, PersistentDataType.INTEGER)!!
    }
}
